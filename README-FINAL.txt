...
Production status is not inferred from this file. See /api/health, OPERATIONS.md, the verified Vercel deployment, and the canonical-domain commit before treating a release as complete.
