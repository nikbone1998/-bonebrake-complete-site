...
console.log('Phase 14 pilot activation checks passed: one-customer caps, external-effects lock, owner activation, checkout claim, and emergency halt contracts verified.');
